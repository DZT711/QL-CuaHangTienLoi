...
import htsc.src_BE.dao.ChiTietPhieuNhapDAO;
import htsc.src_BE.dao.HangHoaDAO;
import htsc.src_BE.dao.NhapHangDAO;
import htsc.src_BE.dao.SanPhamDAO;
import htsc.src_BE.dto.ChiTietPhieuNhapDTO;
import htsc.src_BE.dto.NhapHangDTO;
...
public class QuanLyChiTietPhieuNhap {
    ...
    public static void themChiTietVaoPhieuNhap(Scanner scanner) {
        ...
        try {
            // conn = htsc.src_BE.util.JDBCUtil.getConnection();
