package htsc.src_BE.main;

import htsc.src_BE.dao.TaiKhoanDAO;
import htsc.src_BE.dao.NhanVienDAO;
import htsc.src_BE.dto.TaiKhoanDTO;
import htsc.src_BE.dto.NhanVienDTO;
import java.util.Scanner;
import htsc.src_BE.view.QuanLyKhachHang;
import htsc.src_BE.view.QuanLyNhaCungCap;
import htsc.src_BE.view.QuanLyNhanVien;
import htsc.src_BE.view.QuanLyNhapHang;
import htsc.src_BE.view.QuanLySanPham;
import htsc.src_BE.view.QuanLyChiTietPhieuNhap;
import htsc.src_BE.view.QuanLyHangHoa;
import htsc.src_BE.view.QuanLyHoaDon;
import htsc.src_BE.view.QuanLyTaiKhoan;
...
public class Main {
    ...
    public static boolean forceChangePasswordLoop(String username, String maNV) {
        ...
        while (true) {
            ...
            // Thử đổi mật khẩu
            if (htsc.src_BE.dao.TaiKhoanDAO.batBuocDoiMatKhau(username, newPassword, maNV)) {
